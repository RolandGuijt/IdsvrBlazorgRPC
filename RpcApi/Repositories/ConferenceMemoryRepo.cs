...
namespace RpcApi.Repositories
{
    public class ConferenceMemoryRepo : IConferenceRepo
    {
        ...
        {
            conferences.Add(new Conference { Id = 1, Name = "Update Conference", Location = "Prague", Start = Timestamp.FromDateTime(new DateTime(2021, 11, 18).ToUniversalTime()), AttendeeTotal = 900 });
